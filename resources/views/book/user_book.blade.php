        ...
        <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="h-25 w-full">
                    <a href="#">
                        <img class="mx-auto h-auto dark:hidden" src="{{ asset('images/'. $book->cover) }}" alt="" />
                        <img class="mx-auto hidden h-auto dark:block" src="{{ asset('images/'. $book->cover) }}" alt="" />
                    </a>
                </div>
                <div class="pt-6">
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $book->title }}</a>
                    ...
                    <ul class="mt-2 flex items-center gap-4">
                        <li class="flex items-center gap-2">
                            ...
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ $book->description }}</p>
                        </li>
