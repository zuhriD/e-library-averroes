        ...
        <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="h-25 w-full">
                    <a href="#">
                        <img class="mx-auto h-auto dark:hidden" src="<?php echo e(asset('images/'. $book->cover)); ?>" alt="" />
                        <img class="mx-auto hidden h-auto dark:block" src="<?php echo e(asset('images/'. $book->cover)); ?>" alt="" />
                    </a>
                </div>
                <div class="pt-6">
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white"><?php echo e($book->title); ?></a>
                    ...
                    <ul class="mt-2 flex items-center gap-4">
                        <li class="flex items-center gap-2">
                            ...
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400"><?php echo e($book->description); ?></p>
                        </li>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        ...
                        <a href="#"
                            ...
                            data-book-description="<?php echo e($book->description); ?>"
                            class="borrow-book-btn inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <form class="p-4 md:p-5" action="" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2">
                                <label for="borrow_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Borrow Date</label>
                                <input type="date" name="borrow_date" id="borrow_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                            </div>
                            <div class="col-span-2">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        borrowButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                document.getElementById('name').value = bookTitle;
                document.getElementById('description').value = bookDescription;

                // You can also add a hidden input for the book ID
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\AVERROS\RPL KELAS 11\Sem 2\e-library-averroes\resources\views\book\user_book.blade.php ENDPATH**/ ?>